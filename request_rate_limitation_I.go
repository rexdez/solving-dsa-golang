...
func RateLimitation_I(requests []string) []string {
	...
	// a map with 2D array. 0th index array contains the ith second
	// for 5 second window and 1st index array contains the ith second
	// for 30 second window. 
	...
	for i, val := range requests {
		...
		// Recalculating the seconds for 3- second window
		times_30 := make([]int, 0)
